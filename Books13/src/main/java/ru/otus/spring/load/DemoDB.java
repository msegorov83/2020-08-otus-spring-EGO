...
public class DemoDB implements CommandLineRunner {
    ...
    public DemoDB(GenreRepository genreRepository, BookRepository bookRepository, AuthorRepository authorRepository ) {
    ...
    public void run(String... args) throws Exception {
        ...
        Author idA = authorRepository.findById(1L);
        Genre idG = genreRepository.findById(1L);
